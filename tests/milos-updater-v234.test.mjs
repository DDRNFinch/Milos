...
test('Milos 2.39 uses the lightweight updater',()=>{
  assert.match(index,/milos-updater-v236\.js\?v=2\.39/);
...
test('installed shell remains version-stable between explicit updates',()=>{
  assert.match(sw,/const CACHE_NAME = "milos-assessor-shell-v2\.39"/);
