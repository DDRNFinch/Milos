...
test('Milos 2.34 loads standardized UI last and offline',()=>{
  assert.match(index,/milos-standard-ui-v229\.css\?v=2\.34/);
  assert.match(index,/milos-standard-ui-v229\.js\?v=2\.34/);
...
test('Milos brand has a blue i and appears only in the top-left lockup',()=>{
  ...
  assert.match(js,/hint\.textContent='Tap me to get started'/);
});
