...
test('Milos 2.41 loads standardized UI last and offline',()=>{
  assert.match(index,/milos-standard-ui-v229\.css\?v=2\.41/);
  assert.match(index,/milos-standard-ui-v229\.js\?v=2\.41/);
