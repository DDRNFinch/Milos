...
test('Milos 2.29 loads standardized UI last and offline',()=>{
  assert.match(index,/milos-standard-ui-v229\.css\?v=2\.29/);
  assert.match(index,/milos-standard-ui-v229\.js\?v=2\.29/);
  assert.ok(index.indexOf('milos-standard-ui-v229.css')>index.indexOf('milos-week-calendar-v228.css'));
