...
test('Milos 2.27 loads guided video observation offline', () => {
  assert.match(index, /milos-app-version" content="2\.27"/);
  assert.match(index, /milos-video-observation-v226\.css\?v=2\.27/);
  assert.match(index, /milos-video-observation-v226\.js\?v=2\.27/);
  assert.match(sw, /milos-assessor-shell-v2\.27/);
