...
test('current Milos release loads one unified video engine offline', () => {
  assert.match(index, /milos-app-version" content="\d+\.\d+"/);
  assert.match(index, /milos-video-evidence-v231\.js\?v=\d+\.\d+/);
  assert.match(index, /milos-video-evidence-v231\.css\?v=\d+\.\d+/);
