...
test('current Milos release loads the weekday calendar offline',()=>{
  assert.match(index,/milos-app-version" content="\d+\.\d+"/);
  assert.match(index,/milos-week-calendar-v228\.css\?v=\d+\.\d+/);
  assert.match(index,/milos-week-calendar-v228\.js\?v=\d+\.\d+/);
  assert.match(index,/milos-calendar-manager-v230\.css\?v=\d+\.\d+/);
