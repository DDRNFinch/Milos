...
test("2.43 full-criteria layer remains loaded and cached in the current Milos release after the unified video evidence engine", () => {
  ...
  assert.match(index, /milos-full-criteria-prompts-v243\.css\?v=\d+\.\d+/);
  assert.match(index, /milos-full-criteria-prompts-v243\.js\?v=\d+\.\d+/);
