...
test("2.43 loads and caches the full-criteria prompt layer after the unified video evidence engine", () => {
  ...
  assert.match(index, /milos-full-criteria-prompts-v243\.css\?v=2\.43/);
  assert.match(index, /milos-full-criteria-prompts-v243\.js\?v=2\.43/);
