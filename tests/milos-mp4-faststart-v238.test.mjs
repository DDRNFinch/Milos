...
test('Milos 2.40 loads the MP4 fast-start repair immediately after private media storage and caches it offline',()=>{
  assert.match(index,/milos-mp4-faststart-v238\.js\?v=2\.40/);
