...
test("current release keeps the working AC timestamp engine and layers the streamlined viewer before it", () => {
  ...
  assert.match(index, /milos-app-version" content="2\.72"/);
  assert.match(sw, /milos-assessor-shell-v2\.72/);
